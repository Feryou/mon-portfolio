<template>
  <div class="min-h-screen overflow-x-hidden bg-white text-black font-mono">
    <Navbar />
      ...
      >
        <template v-for="(project, index) in projects" :key="index">
          ...
          >
            ...
            ></div>
            <div
              class="relative z-10 group w-full md:max-w-md h-[220px] md:h-[270px] overflow-hidden rounded-[30px] border border-black bg-white transition-all duration-500 hover:scale-105 hover:shadow-xl"
            >
              <img
                :src="project.image"
                :alt="project.title"
